...
class VelocityPlanner:
    ...
    def decelerate_profile(self, path, start_speed): 
        ...
        #in the next lines it's normal to have a negative as we decelarte.
        decel_distance = calc_distance(start_speed, slow_speed, -self._a_max)
        #the first trapezoidal segment
        brake_distance = calc_distance(slow_speed, 0, -self._a_max)
        #the second trapezoidal segment
        ...
        # time.
        #for hard decelartion it mean he will use ramp profile with no smooth segment, the second one in trap.
        if brake_distance + decel_distance + stop_line_buffer > path_length:
            ...
            for i in reversed(range(stop_index)):
                ...
                #we need positive acceleration to calculate the final velocity
                #https://www.coursera.org/learn/motion-planning-self-driving-cars/discussions/weeks/7/threads/VFqIjIvtEem0yBI86_RF3A
