...
class PathOptimizer:
    ...
    def optimize_spiral(self, xf, yf, tf):
        ...
        self._yf = yf
        self._tf = tf
        # The straight line distance serves as a lower bound on any path's , magnitude of vector
        ...
        # bounds = ...P1,P2,Sf
        sf_max = float('Inf')
        bounds = [[-0.5,0.5],[-0.5,0.5],[sf_0,sf_max]]
        # ------------------------------------------------------------------
        ...
        #scipy.optimize.minimize(fun, x0, method=None, jac=None, bounds=None)
